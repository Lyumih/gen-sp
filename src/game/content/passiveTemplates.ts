...
const PASSIVE_ENTRIES: Record<string, PassiveTemplate> = {
  ...
  warrior_fortitude: {
    ...
    descriptionRu:
      "+2 к защите при получении урона. Прокачка при каждом полученном уроне.",
  },
  warrior_vigor: {
    id: "warrior_vigor",
    label: "Выносливость",
    ...
    synergies: ["cleave"],
    descriptionRu:
      "+15% к максимуму HP при получении урона. Прокачка при каждом полученном уроне.",
  },
  warrior_riposte: {
    id: "warrior_riposte",
    label: "Ответный удар",
  ...
  warrior_battle_line: {
    ...
    descriptionRu:
      "В начале хода: +1 к защите за каждого союзника в соседней клетке.",
  },
  ...
  mage_arcane_focus: {
    ...
    synergies: ["fireball"],
    descriptionRu:
      "+2 к силе магии при атаке умением. Прокачка при каждой атаке картой.",
  },
  mage_mana_well: {
    id: "mage_mana_well",
    label: "Колодец маны",
    ...
    descriptionRu:
      "+20% к мане при атаке умением. Прокачка при каждой атаке картой.",
  },
  mage_ignite: {
    id: "mage_ignite",
    label: "Воспламенение",
  ...
  ranger_keen_eye: {
    ...
    descriptionRu:
      "+2 к шансу крита при базовой атаке. Прокачка при каждом ударе.",
  },
  ranger_swiftness: {
    id: "ranger_swiftness",
    ...
    descriptionRu:
      "+15% к скорости при перемещении. Прокачка при каждом ходе ≥1 клетки.",
  },
  ranger_double_tap: {
  ...
  ranger_far_sight: {
    ...
    synergies: ["power_shot"],
    descriptionRu:
      "+1 к дальности атаки, если рядом нет врага. Прокачка при перемещении.",
  },
  ...
  healer_gentle_hands: {
    ...
    synergies: ["heal"],
    descriptionRu:
      "+2 к силе исцеления при лечении умением. Прокачка при каждом исцелении.",
  },
  healer_vitality: {
    id: "healer_vitality",
    ...
    descriptionRu:
      "+15% к максимуму HP при тике регенерации. Прокачка при каждом тике.",
  },
  healer_splash_heal: {
    ...
    synergies: ["heal"],
    descriptionRu:
      "20% шанс исцелить вторую цель на 50% силы при лечении умением.",
  },
  healer_renewal: {
    id: "healer_renewal",
    label: "Обновление",
  ...
  rogue_smoke_veil: {
    ...
    synergies: ["smoke_bomb"],
    descriptionRu:
      "15% шанс полностью уклониться от урона при получении удара.",
  },
  ...
  paladin_faith: {
    ...
    descriptionRu:
      "+15% к силе исцеления при лечении умением. Прокачка при каждом исцелении.",
  },
  ...
  paladin_intercession: {
    ...
    synergies: ["lay_on_hands"],
    descriptionRu:
      "20% шанс в начале хода исцелить союзника с HP <50% в радиусе 2.",
  },
  ...
  warlock_soul_harvest: {
    ...
    descriptionRu:
      "+15% к максимуму HP при убийстве врага. Прокачка при каждом убийстве.",
  },
  warlock_spread_plague: {
    ...
    synergies: ["corruption"],
    descriptionRu:
      "20% шанс распространить DoT на соседних врагов при убийстве.",
  },
  warlock_life_tap: {
    id: "warlock_life_tap",
    ...
    descriptionRu:
      "8% вампиризма от урона умений. Прокачка при каждой атаке картой.",
  },
  ...
  berserker_desperation: {
    ...
    synergies: ["blood_rage"],
    descriptionRu:
      "+25% к урону базовой атаки при HP ниже 50%. Прокачка при каждом ударе.",
  },
};
