...
const ENEMY_ARCHETYPES: Readonly<Record<string, EnemyArchetype>> = {
  ...
  enemy_ether_duelist: {
    ...
    counterClass: 'warrior',
    baseStats: { ...REGULAR_STATS, health: 10, defense: 1, magicPower: 4, mana: 8, manaRegen: 5, speed: 3, initiative: 9 },
  ...
  enemy_plague_herald: {
    ...
    counterClass: 'healer',
    baseStats: { ...REGULAR_STATS, health: 11, magicPower: 4, mana: 8, manaRegen: 5, initiative: 7 },
    baseAttack: 'magic_bolt',
  ...
  enemy_dark_cultist: {
    ...
    baseStats: { ...REGULAR_STATS, health: 11, magicPower: 4, mana: 8, manaRegen: 5 },
    baseAttack: 'magic_bolt',
  ...
  enemy_holy_crusader: {
    ...
    baseStats: { ...REGULAR_STATS, health: 14, defense: 3, attack: 4, healPower: 2, mana: 6, manaRegen: 3 },
    baseAttack: 'strike',
  ...
  enemy_lightbound: {
    ...
    counterClass: 'warlock',
    baseStats: { ...REGULAR_STATS, health: 12, healPower: 4, mana: 8, manaRegen: 5, defense: 2 },
    baseAttack: 'magic_bolt',
  ...
  enemy_frost_shaman: {
    ...
    baseStats: { ...REGULAR_STATS, health: 10, magicPower: 4, mana: 8, manaRegen: 5, speed: 3, initiative: 9 },
    baseAttack: 'magic_bolt',
