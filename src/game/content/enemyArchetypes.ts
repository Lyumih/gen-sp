...
const ENEMY_ARCHETYPES: Readonly<Record<string, EnemyArchetype>> = {
  ...
  enemy_ether_duelist: {
    ...
    counterClass: 'warrior',
    baseStats: { ...REGULAR_STATS, health: 10, defense: 1, magicPower: 4, mana: 10, manaRegen: 5, speed: 3, initiative: 9 },
  ...
  enemy_mana_leech: {
    ...
    counterClass: 'mage',
    baseStats: { ...REGULAR_STATS, health: 11, magicPower: 4, mana: 10, manaRegen: 5, speed: 3, initiative: 8 },
    baseAttack: 'magic_bolt',
  ...
  enemy_shadow_stalker: {
    ...
    counterClass: 'ranger',
    baseStats: { ...REGULAR_STATS, health: 10, defense: 1, attack: 4, speed: 4, initiative: 10, critChance: 6, manaRegen: 1 },
    baseAttack: 'strike',
  ...
  enemy_plague_herald: {
    ...
    counterClass: 'healer',
    baseStats: { ...REGULAR_STATS, health: 11, magicPower: 4, mana: 10, manaRegen: 5, initiative: 7 },
    baseAttack: 'magic_bolt',
  ...
  enemy_bone_assassin: {
    ...
    counterClass: 'healer',
    baseStats: { ...REGULAR_STATS, health: 10, attack: 4, speed: 4, initiative: 10, critChance: 8, manaRegen: 1 },
    baseAttack: 'strike',
  ...
  enemy_storm_caller: {
    ...
    counterClass: 'rogue',
    baseStats: { ...REGULAR_STATS, health: 10, magicPower: 5, mana: 10, manaRegen: 6, initiative: 8 },
    baseAttack: 'magic_bolt',
  ...
  enemy_dark_cultist: {
    ...
    baseStats: { ...REGULAR_STATS, health: 11, magicPower: 4, mana: 10, manaRegen: 5 },
    baseAttack: 'magic_bolt',
  ...
  enemy_holy_crusader: {
    ...
    baseStats: { ...REGULAR_STATS, health: 14, defense: 3, attack: 4, healPower: 2, mana: 12, manaRegen: 3 },
    baseAttack: 'strike',
  ...
  enemy_lightbound: {
    ...
    counterClass: 'warlock',
    baseStats: { ...REGULAR_STATS, health: 12, healPower: 4, mana: 12, manaRegen: 5, defense: 2 },
    baseAttack: 'magic_bolt',
  ...
  enemy_frost_shaman: {
    ...
    baseStats: { ...REGULAR_STATS, health: 10, magicPower: 4, mana: 10, manaRegen: 5, speed: 3, initiative: 9 },
    baseAttack: 'magic_bolt',
  ...
  boss_spell_eater: {
    ...
    counterClass: 'mage',
    baseStats: { ...BOSS_STATS, health: 22, magicPower: 6, mana: 16, manaRegen: 6, defense: 2 },
    baseAttack: 'magic_bolt',
  ...
  boss_soul_reaper: {
    ...
    counterClass: 'healer',
    baseStats: { ...BOSS_STATS, health: 23, magicPower: 5, mana: 14, manaRegen: 5 },
    baseAttack: 'magic_bolt',
  ...
  boss_decay_avatar: {
    ...
    counterClass: 'paladin',
    baseStats: { ...BOSS_STATS, health: 24, magicPower: 5, mana: 14, manaRegen: 5 },
    baseAttack: 'magic_bolt',
  ...
  boss_high_inquisitor: {
    ...
    counterClass: 'warlock',
    baseStats: { ...BOSS_STATS, health: 25, attack: 5, healPower: 3, mana: 14 },
    baseAttack: 'strike',
  ...
  hero_ranger: {
    ...
    threatTags: ['hero', 'arena'],
    counterClass: 'ranger',
    baseStats: { ...REGULAR_STATS, health: 11, defense: 2, attack: 4, speed: 3, initiative: 9, critChance: 5, manaRegen: 3 },
    baseAttack: 'shot',
  ...
  hero_battle_mage: {
    ...
    threatTags: ['hero', 'arena'],
    counterClass: 'mage',
    baseStats: { ...REGULAR_STATS, health: 10, defense: 1, magicPower: 5, mana: 10, manaRegen: 6, initiative: 8 },
    baseAttack: 'magic_bolt',
  ...
  enemy_chaos_aberration: {
    ...
    counterClass: 'warrior',
    baseStats: { ...REGULAR_STATS, health: 11, attack: 3, magicPower: 3, manaRegen: 3, speed: 3, initiative: 8 },
    baseAttack: 'strike',
  ...
  enemy_mutant_wanderer: {
    ...
    threatTags: ['swamp', 'chaotic'],
    counterClass: 'ranger',
    baseStats: { ...REGULAR_STATS, health: 12, attack: 4, speed: 3, critChance: 5, manaRegen: 1 },
    baseAttack: 'strike',
  ...
  enemy_shifting_shaman: {
    ...
    counterClass: 'mage',
    baseStats: { ...REGULAR_STATS, health: 11, magicPower: 4, mana: 10, manaRegen: 5, initiative: 8 },
    baseAttack: 'magic_bolt',
