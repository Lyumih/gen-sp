...
const ARTICLES: readonly HelpArticle[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      '**Активна**, только если герой в **отряде** (хаб или expedition); в **резерве** — «неактивна», бонусы не работают.',
      'Упавший в expedition **остаётся в squadSnapshot** — мета-бонусы его склонности **не отключаются**.',
